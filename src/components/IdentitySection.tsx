...
export default function IdentitySection() {
  return (
    <section id="identity" className="relative min-h-screen py-24 md:py-32 px-6 md:px-8 lg:px-12 flex items-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.div variants={staggerItem} className="overflow-hidden">
              <motion.p
                className="text-xs uppercase tracking-[0.3em] text-premium-accent font-medium mb-6"
              >
                Philosophy
              </motion.p>
